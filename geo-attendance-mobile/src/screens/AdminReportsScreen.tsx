...
const AdminReportsScreen: React.FC = () => {
  ...
  return (
    ...
    >
      <Text style={styles.title}>Global Attendance</Text>
      <Text style={styles.subtitle}>System-wide participation analytics</Text>
            ...
            {expandedCourse === course.courseId && (
              <View style={styles.groupsList}>
                ...
                {course.groups.length === 0 && (
                   <Text style={styles.emptyText}>No groups for this course.</Text>
                )}
              </View>
            )}
          </View>
...
const styles = StyleSheet.create({
  ...
  emptyText: { ...Typography.Typography.body, color: Colors.textSecondary, textAlign: 'center', marginVertical: 10 },
});
